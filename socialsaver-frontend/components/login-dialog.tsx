      ...
      <DialogContent className="sm:max-w-md bg-card border-border">
        <DialogHeader className="text-center">
          ...
          <p className="text-muted-foreground text-sm mt-1">
            {isLogin ? "Sign in to continue using SocialSaver" : "Get started with SocialSaver today"}
          </p>
        </DialogHeader>

        {/* Google SSO Button - Primary action for registration */}
        <div className="mt-6">
          <Button
            type="button"
            variant="outline"
            onClick={handleGoogleSignIn}
            className="w-full bg-transparent border-border text-foreground hover:bg-secondary gap-3 h-11"
          >
